    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $edit = '<a href="'.route('admin.child-category.edit', $query->id).'" class="btn btn-primary">Edit</a>';
                $delete = '<a href="'.route('admin.child-category.destroy', $query->id).'" class="btn btn-danger ml-2 delete-item">Delete</a>';
                return $edit.$delete;
            })
